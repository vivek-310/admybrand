...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white/5 dark:bg-black/5 backdrop-blur-lg border-b border-gray-200/10 dark:border-white/10 transition-colors duration-200">
